...
public class MainWindowController {
    ...
    public void writePrivateMessage() throws Exception {
        String toUser = JOptionPane.showInputDialog(this.wnd, "Empf�nger der Nachricht:");
        if (toUser == null) return;
        while (toUser.trim().isEmpty()){
        	JOptionPane.showMessageDialog(this.wnd, this.username + ": Leerer Empf�nger!", "Achtung", JOptionPane.WARNING_MESSAGE);
            toUser = JOptionPane.showInputDialog(this.wnd, "Empf�nger der Nachricht:");
        ...
        // TODO: Private Nachricht tats�chlich verschicken
